...
SOURCES = [
    # ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
    #  30 مصدر قوي — يعطي WS+TLS+443 configs نظيفة
    #  يُحدَّث يومياً — SNI نظيف أو فارغ
    # ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━

    # ── Top Aggregators (يجمع من مئات المصادر) ──────────
    ...
    # ── CF-Focused Sources (CF WS+TLS configs) ──────────
    ...
    # ── Telegram Channels (CF configs heavy) ─────────────
    "https://t.me/s/iP_CF",
...
def is_provider_locked(raw:str) -> bool:
    """
    Whitelist: نقبل فقط SNI فارغ، IP مباشر، أو Bug Host معتمد.
    أي domain آخر = مصدر حقن SNI = مرفوض (chat.openai.com, etc.)
    """
    sni = extract_sni(raw).lower().strip()
    if not sni: return False                    # فارغ = مقبول
    if _IP4_RE.match(sni): return False         # IP مباشر = مقبول
    if sni in _BUG_SET: return False            # Bug Host معتمد = مقبول
    return True                                  # أي domain آخر = مرفوض
